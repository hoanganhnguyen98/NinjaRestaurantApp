...
import { Container, Content, Card, CardItem, Text, Button, Left, Body, ListItem, Input } from 'native-base';
                ...
                <Content>
                        ...
                        <ListItem icon>
                            <Left>
                                <Button style={{ backgroundColor: "#ffffff" }}>
                                    <FAIcon name="envelope-o" size={20} style={{color: Colors.appColor}}/>
                                </Button>
                            </Left>
                            <Body>
                    ...
                    <Card>
                        <ListItem icon noBorder>
                            <Left>
                                <Button style={{ backgroundColor: "#ffffff" }}>
                                    <FAIcon name="barcode" size={20} style={{color: Colors.appColor}}/>
                                </Button>
                            </Left>
                            <Body>
                        ...
                        <ListItem icon>
                            ...
                            <Body>
                                <Input placeholder={'check code from email'} onChangeText={(inputCode)=>this.setState({inputCode})} />
                            </Body>
                        </ListItem>
                        <ListItem icon noBorder>
                            <Left>
                                <Button style={{ backgroundColor: "#ffffff" }}>
                                    <FAIcon name="lock" size={20} style={{color: Colors.appColor}}/>
                                </Button>
                            </Left>
                            <Body>
