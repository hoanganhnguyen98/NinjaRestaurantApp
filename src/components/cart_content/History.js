      ...
      <Left>
        {data.item.status === 'new' ? (
          <Button success rounded bordered>
            <Text>
              <MCIcon name="pot-mix" size={20} />
            </Text>
          </Button>
        ) : data.item.status === 'done' ? (
          <Button danger rounded bordered>
            <Text>
              <MCIcon name="account-check" size={20} />
            </Text>
          </Button>
        ) : (
          <Button warning rounded bordered>
            <Text>
              <MCIcon name="truck-delivery" size={20} />
            </Text>
          </Button>
        )}
      </Left>
      ...
      <View style={Styles.menu.foodList}>
        <Header style={{backgroundColor: '#ffffff'}}>
          <Button transparent>
            <Button transparent>
              <Text>
                <MCIcon name="cart-arrow-up" size={20} />
              </Text>
            </Button>
            <Button light transparent>
              <Text>
                <MCIcon name="arrow-right-bold" size={15} />
              </Text>
            </Button>
